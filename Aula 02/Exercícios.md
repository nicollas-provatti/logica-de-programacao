...
**Dica:** Para calcular 10% de qualquer valor, por exemplo, basta multiplicar esse valor por **0,1**.  
Isso acontece porque 10% significa **10 dividido por 100**, ou seja:

$$
10\% = \frac{10}{100} = 0,1
$$

Por exemplo, para descobrir 10% de 100:

$$
100 \times 0,1 = 10
$$

Portanto, **10% de 100 é 10**.
